...
class L001(unittest.TestCase):
    ...
    def test_001(self):
        ...
        driver.find_element_by_id("name").send_keys(u"新年快乐！")
        iframe = driver.find_element_by_class_name("ke-edit-iframe")
        driver.switch_to_frame(iframe)
        driver.find_element_by_class_name("ke-content").send_keys("大家好啊！！！！")
        ...
        if driver.find_element_by_class_name("col-sm-8").text == "test":
            log.write("[success !]OA-论坛-001\n")
            driver.quit()
        else:
            log.write("[fail !]OA-论坛-001\n")
            driver.quit()
        log.close()
        time.sleep(2)
